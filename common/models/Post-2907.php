...
class Post extends ActiveRecord
{
    ...
    {
        return [
            [['created_at', 'updated_at', 'enabled', 'deleted'], 'safe'],
...
/*begin functions for multiply images upload*/
    public function getImages(){
        return $this->hasMany(SystemFiles::className(), ['attachment_id' => 'id'])->andWhere(['attachment_type'=>self::tableName()]);
    }
    ...
    public function getImagesPreview()
    {
        ...
        foreach($this->images as $img){
            $Preview[] =  Html::a(Html::img($img->imgSrc), ['/bc-places/update', 'id' => $this->id], ['class' => 'modal-form']);
        }
        return $Preview;
    }
