...
class User extends ActiveRecord implements IdentityInterface
{
    ...
    public function rules()
    {
        return [
            ...
            [['activated_at', 'last_login', 'last_seen', 'created_at', 'updated_at'], 'safe'],
    ...
    {
        //return SystemFiles::find()->where(['attachment_id' => $this->id])->andWhere(['attachment_type' => self::tableName()]);
