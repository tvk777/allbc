    ...
    <div class="row">
        ...
        <div class="search_city">
                ...
                <div class="select_2_wrapp">
                    <div class="custom_select_2">
                        ...
                        <div class="custom_select_list">
                            <div data-value="1" class="sel-type custom_select_item selected"><a
                                    href="#"><?= Yii::t('app', 'Rent') ?></a>
                            </div>
                            <div data-value="2" class="sel-type custom_select_item"><a
            ...
            <form action="" id="main_form">
                ...
                <input id="submit_main_form" class="gradient_pill search" type="submit"
