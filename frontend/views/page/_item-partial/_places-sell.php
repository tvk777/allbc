<?php
$script = <<< JS
var tableSell = $("#simpleTableSell").stupidtable();
tableSell.on("aftertablesort", function (event, data) {
...
JS;
$this->registerJs($script, $this::POS_READY, 'stupidtableSell');
?>
    ...
    <div class="row row_2">
        <div class="inner_box">
            ...
            <div class="two_cols_3 two_cols_3_2 clearfix">
                <div class="right">
                    <div class="galleries_wrapp" data-galleries="galleries_4">
                ...
                <div class="left">
                    <div class="scroll_x">
                        <table id="simpleTableSell" class="table_5 places_table"
                               data-galleries-table="galleries_4">
                            <thead>
